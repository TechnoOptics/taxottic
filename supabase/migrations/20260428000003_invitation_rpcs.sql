-- Lookup an invitation by token without exposing the table publicly.
-- Returns the company name + role + invitee email so a public landing page
-- can render context before sign-in.
...
-- Accept the invitation for the currently-signed-in user, if their email
-- matches the invitation. Returns the resulting company public_id.
