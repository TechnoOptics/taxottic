-- Recovered 20260430193611 (banking_part3_rls) from supabase_migrations.schema_migrations.
...
-- bank_connections: any company member can read / a manager can write
...
-- bank_accounts: read-through via parent connection
...
-- account_transactions: read for members, manager write
...
-- transaction suggestions: piggyback on the transaction's read scope
...
-- sales_tax_state_rates: public read; no writes from app
...
-- sales_tax_records: company-scoped
