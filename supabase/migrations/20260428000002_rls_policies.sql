-- Taxottic Phase 1: row-level security policies
-- Default: deny everything. Each policy below opens a specific path.
...
-- ----------------------------------------------------------------------------
-- super_admins: read-only to super admins, never writable from app
-- ----------------------------------------------------------------------------
